...
-- UUID identifiers (stored as TEXT, generated by gen_random_uuid()) for the
-- custom-commands domain. Pre-prod, so a clean
...
CREATE TABLE custom_commands (
    ...
    group_id           TEXT        REFERENCES command_groups(id) ON DELETE SET NULL,
...
-- command_id is the owning command's UUID string; '' is the guild-shared
-- sentinel (was 0 under the integer scheme).
