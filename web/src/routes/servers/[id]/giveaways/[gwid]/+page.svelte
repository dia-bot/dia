<script lang="ts">
	...
	// ── Winner-announcement accent ──────────────────────────────────────────────
	// The announcement is edited in place (AnnounceEditor), so the only thing the
	// page resolves here is the embed accent the ended card uses.
