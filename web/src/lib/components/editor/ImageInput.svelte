...
<div class="space-y-1.5">
	...
	>
		<input
			...
			class="h-8 w-full min-w-0 rounded-lg border border-line bg-ink-2 px-2.5 text-sm text-ink outline-none transition-all hover:border-faint focus:border-faint focus:ring-2 focus:ring-line-strong"
		/>
		{#if guildId}
			<button
				type="button"
